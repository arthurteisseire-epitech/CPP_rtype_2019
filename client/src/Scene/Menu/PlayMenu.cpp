...
Client::PlayMenu::PlayMenu(Client::IScene *prev) : _prev(prev), _components({
    ...
    {new Client::Button(2, 2, buttonPosList[0], "Menu/ButtonSolo.png"), &Client::PlayMenu::solo},
    {new Client::Button(3, 2, buttonPosList[1], "Menu/ButtonOnline.png"), &Client::PlayMenu::online},
    {new Client::Button(4, 2, buttonPosList[2], "Menu/ButtonBack.png"), &Client::PlayMenu::back}
...
void Client::PlayMenu::solo(Client::Window &window)
{
    ...
    _components.push_back(new Fading(5, 3, 0.5f));
