...
std::unordered_map<std::string, game::GameSprite::Type> game::GameSprite::initTypes()
{
    return {{"spaceship_right_most", SPACESHIP_RIGHT_MOST}, {"spaceship_right", SPACESHIP_RIGHT},
        {"spaceship_normal", SPACESHIP_NORMAL}, {"spaceship_left", SPACESHIP_LEFT},
        {"spaceship_left_most", SPACESHIP_LEFT_MOST}, {"spaceship_right_most_rev", SPACESHIP_RIGHT_MOST_REV},
        {"spaceship_right_rev", SPACESHIP_RIGHT_REV}, {"spaceship_normal_rev", SPACESHIP_NORMAL_REV},
        {"spaceship_left_rev", SPACESHIP_LEFT_REV}, {"spaceship_left_most_rev", SPACESHIP_LEFT_MOST_REV},

        {"basic_missile_launch", BASIC_MISSILE_LAUNCH}, {"basic_missile_launch_2", BASIC_MISSILE_LAUNCH_2},
        {"basic_missile_launched", BASIC_MISSILE_LAUNCHED}, {"basic_missile_launched_rev", BASIC_MISSILE_LAUNCHED_REV},
